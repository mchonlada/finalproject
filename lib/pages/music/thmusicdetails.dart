...
class THMusicDetails extends StatefulWidget {
  static const routeName = '/THMusicDetail';

  const THMusicDetails({Key? key}) : super(key: key);

  @override
  _THMusicDetailsState createState() => _THMusicDetailsState();
}

class _THMusicDetailsState extends State<THMusicDetails> {
